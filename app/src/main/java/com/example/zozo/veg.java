...
public class veg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price.put(a.getText().toString(),40);
        price.put(b.getText().toString(),30);
        price.put(c.getText().toString(),45);
        price.put(d.getText().toString(),35);
        ...
        cart5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(veg.this,f1.class);
    ...
    public void countDE12(View view) {
        if(d.isChecked()) {
            ...
            Toast.makeText(veg.this, "Please Select That Item First", Toast.LENGTH_SHORT).show();
            size12.setText("");
        }}
    @RequiresApi(api = Build.VERSION_CODES.N)
