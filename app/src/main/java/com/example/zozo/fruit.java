...
public class fruit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price.put(a.getText().toString(),110);
        price.put(b.getText().toString(),50);
        ...
        cart5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(fruit.this,f1.class);
    ...
    public void countDE12(View view) {
        if(d.isChecked()) {
            ...
            Toast.makeText(fruit.this, "Please Select That Item First", Toast.LENGTH_SHORT).show();
            size12.setText("");
        }}
    @RequiresApi(api = Build.VERSION_CODES.N)
