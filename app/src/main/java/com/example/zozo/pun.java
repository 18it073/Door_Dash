...
public class pun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price.put(a.getText().toString(),180);
        price.put(b.getText().toString(),150);
        price.put(c.getText().toString(),200);
        price.put(d.getText().toString(),180);
        ...
        cart5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(pun.this,f1.class);
    ...
    public void countDE12(View view) {
        if(d.isChecked()) {
            ...
            Toast.makeText(pun.this, "Please Select That Item First", Toast.LENGTH_SHORT).show();
            size12.setText("");
        }}
    @RequiresApi(api = Build.VERSION_CODES.N)
