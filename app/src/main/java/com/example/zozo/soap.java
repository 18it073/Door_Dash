...
public class soap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price.put(a.getText().toString(),22);
        price.put(b.getText().toString(),30);
        price.put(c.getText().toString(),35);
        price.put(d.getText().toString(),40);
        ...
        cart5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(soap.this,f1.class);
    ...
    public void countDE12(View view) {
        if(d.isChecked()) {
            ...
            Toast.makeText(soap.this, "Please Select That Item First", Toast.LENGTH_SHORT).show();
            size12.setText("");
        }}
    @RequiresApi(api = Build.VERSION_CODES.N)
