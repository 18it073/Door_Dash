...
public class naan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price.put(c.getText().toString(),25);
        ...
        cart5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(naan.this,f1.class);
    ...
    public void countDE12(View view) {
        if(d.isChecked()) {
            ...
            Toast.makeText(naan.this, "Please Select That Item First", Toast.LENGTH_SHORT).show();
            size12.setText("");
        }}
    @RequiresApi(api = Build.VERSION_CODES.N)
